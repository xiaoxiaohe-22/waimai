  ...
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back" @click="$router.back()">
        <i style="font-size: 35px;color: white" class="iconfont iconleft"/>
      </a>
    </nav>
    <div class="shop-content" @click="isShowModal = true">
    ...
    <div class="shop-header-discounts">
      <div class="discounts-left">
        <div class="activity activity-green" @click="isShowSheet= true">
          <span class="content-tag">
    ...
    <div class="shop-brief-modal" v-if="isShowModal" >
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowModal=false">
          <span class="iconfont iconclose"></span>
        </div>
      </div>
      <div class="brief-modal-cover" @click="isShowModal=false"></div>
    </div>
    <div class="activity-sheet" v-if="isShowSheet" >
      ...
      <div class="activity-sheet-cover" @click="isShowSheet=false"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  data(){
    return {
      isShowModal:false, //是否显示中间的遮罩层
      isShowSheet:false  //是否显示底部的遮罩
    }
  }
}
</script>
